...
def create_test_matrix():
    ...
    print(f"Generated random interactions and saved to 'updated_product_store_interactions.csv'")
...
def collect_statistics(csv_file):
    ...
    store_with_most_interactions_name = store_names.get(store_with_most_interactions, "Unknown Store")
    product_with_most_interactions_name = product_names.get(product_with_most_interactions, "Unknown Product")

    # Print out the statistics
    print(f"Total interactions: {total_interactions}")
    print(f"Positive interactions: {positive_interactions} ({positive_percentage:.2f}%)")
